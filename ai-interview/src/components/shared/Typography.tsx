...
export const TypographyH1 = ({ children, className }: TypographyProps) => (
  <h1
    className={cn(
      "scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-6xl text-white font-heading",
      className
    )}
  >
    {children}
...
export const TypographyH2 = ({ children, className }: TypographyProps) => (
  <h2
    className={cn(
      "scroll-m-20 pb-2 text-3xl font-semibold tracking-tight first:mt-0 text-white font-heading",
      className
    )}
  >
    {children}
...
export const TypographyH3 = ({ children, className }: TypographyProps) => (
  <h3
    className={cn(
      "scroll-m-20 text-2xl font-semibold tracking-tight text-white font-heading",
      className
    )}
  >
    {children}
...
export const TypographyP = ({ children, className }: TypographyProps) => (
  <p
    className={cn(
      "leading-7 [&:not(:first-child)]:mt-6 text-slate-400",
      className
    )}
  >
    {children}
