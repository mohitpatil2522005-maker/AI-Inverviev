...
export default function SettingsPage() {
  ...
  return (
    <PageTransition>
      <div className="max-w-5xl space-y-8 pb-12 mx-auto">
        ...
        <GlassCard className="p-0 overflow-hidden">
          <Tabs
            ...
            className="md:flex-row flex min-h-[600px] flex-col"
          >
            {/* Sidebar Tabs */}
            <div className="md:w-64 md:border-b-0 md:border-r border-white/10 bg-white/[0.01] p-4 w-full border-b">
              <TabsList className="gap-1 p-0 flex h-auto flex-col border-0 bg-transparent">
                {[
                  ...
                  <TabsTrigger
                    key={tab.value}
                    value={tab.value}
                    className="gap-3 px-4 py-3 rounded-xl text-sm font-medium hover:bg-white/5 w-full justify-start transition-all data-[state=active]:bg-primary/20 data-[state=active]:text-primary"
                  >
            ...
            <div className="p-8 flex-1">
              ...
              <TabsContent value="profile" className="m-0 space-y-8">
                <div className="gap-6 flex items-center">
                  <div className="group relative">
                    ...
                    <button className="inset-0 bg-black/40 absolute flex items-center justify-center rounded-full opacity-0 transition-opacity group-hover:opacity-100">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Professional Plan • Member since Jan 2024
                    </p>
                    <Button
                      variant="outline"
                      size="sm"
                      className="mt-3 h-8 bg-white/5 border-white/10 text-sm"
                    >
                      Remove Photo
                    </Button>
                  </div>
              ...
              <TabsContent value="security" className="m-0 space-y-8">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <button
                          ...
                          className="right-3 text-slate-500 absolute top-1/2 -translate-y-1/2"
                        >
                ...
                <div className="space-y-6">
                  ...
                  <div className="p-4 rounded-2xl bg-white/[0.02] border-white/5 flex items-center justify-between border">
                    <div className="gap-4 flex items-center">
                      <div className="p-2 rounded-lg bg-green-500/10 border-green-500/20 text-green-400 border">
                        <Smartphone size={20} />
                      </div>
                      <div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-slate-500">
                          AI analyzes your confidence and sentiment
                        </p>
                      </div>
                      <Switch checked />
                    </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="gap-4 grid grid-cols-3">
                    {[
                      ...
                      <button
                        key={theme.id}
                        className={`p-6 rounded-2xl gap-3 flex flex-col items-center border transition-all ${
                          theme.active
                      ...
                      >
                        <theme.icon
                          size={24}
                          className={
                            theme.active ? "text-primary" : "text-slate-500"
                          }
                        />
                        <span
                          className={`text-sm font-bold ${theme.active ? "text-white" : "text-slate-500"}`}
                        >
                          {theme.label}
                        </span>
                      </button>
                  ...
                  <div className="p-4 rounded-2xl bg-white/[0.02] border-white/5 flex items-center justify-between border">
                    <div>
                      ...
                      <p className="text-sm text-slate-500">
                        Improves readability for text elements
                      </p>
                    </div>
                    <Switch />
                  </div>
