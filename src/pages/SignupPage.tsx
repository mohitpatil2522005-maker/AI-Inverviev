  ...
  return (
    <div className="w-full flex items-center justify-center py-10 sm:py-16">
      <div className="max-w-md w-full bg-white/5 border border-white/10 p-6 sm:p-8 lg:p-10 rounded-3xl shadow-2xl backdrop-blur-md">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-center mb-6 sm:mb-8 text-white tracking-tight">Create Account</h2>
        ...
        <div className="mt-6 sm:mt-8 text-center">
          <p className="text-sm sm:text-base text-gray-400">
            Already have an account? <button onClick={() => navigate('/login')} className="text-blue-400 hover:text-blue-300 font-semibold transition-colors">Log in</button>
          </p>
        </div>
      </div>
    </div>
